...
public class E01StringBasic extends Object {
	...
	public static void main(String[] args) {
		...
		/*
		 String 클래스의 객체생성 방법 1 : new를 사용한다.
		...
		/*
		 str1, str2는 String객체의 창조값을 가지고 있으므로
		  아래는 창조값에 대한 비교를 진행한다.
		 */
		if(str1==str2) {
		...
		/*
		 equals() 메소드
		 	...
		 	문자열을 비교하도록 만들어진 메소드이다. 즉 아래는 객체에 실제 저장된
		 	문자열에 대한 비교가 이루어진다.
		 */
		if(str1.equals(str2)) {
		...
		/*
		 자바에서 문자열 객체를 생성할 떄 new를 사용하지 않고 "를 사용하면
