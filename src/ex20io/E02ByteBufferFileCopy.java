...
/*
 1byte씩 읽어서 저장하는 것보다 1024byte씩 읽을 수 있는 버퍼(Buffer)를 이용하므로 복사 속도가
 훨씬 빠르다. 스트림 혹은 네트워크를 통해 파일을 전송할때 버퍼를 사용하는 이유는 바로 이런 속도차 때문이다.
 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			while(true) {
				...
				/*
				 읽어낸 내용을 파일에 입력함. 버퍼에 저장된 데이터를 인덱스 0의 위치에서
				 readLen의 크기만큼 전송한다.
				 */
			...
			System.out.println("알수없는 예외가 발생되었습닌다.");
		}
	}
