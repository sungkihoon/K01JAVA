...
public class E05LocalDateTimeO {
	...
	public static void main(String[] args) {
		...
		LocalDateTime ofDateTime =
				LocalDateTime.of(2012, 4, 3, 4, 58, 32);
		...
		LocalDateTime nowSunday =
				LocalDateTime.now().with(TemporalAdjusters.next
						(DayOfWeek.SUNDAY));
		System.out.println("가장 가까운 다음 일요일 : "+nowSunday);

		LocalDate fourthSunday =
				LocalDate.of(2020, 3, 1).with(TemporalAdjusters.next
						(DayOfWeek.SUNDAY));
		System.out.println("2018년 3월 기준, 네 번째 일요일 : "
				+ fourthSunday);

		LocalDate first12Sunday =
				LocalDate.of(2020, 3, 1).with(TemporalAdjusters
						.firstInMonth(DayOfWeek.SUNDAY));
