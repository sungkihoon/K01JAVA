...
class Man{
	...
	/*
	 만약 자식클래스에서 super()를 통해 매개변수를 전달하지 않는다면 초기화가 되지않아 
	 null이 출력될 수 있다.
	 */
	public Man() {
...
class BusinessMan extends Man{
	...
	/*
	 상속받은 자식클래스에서는 부모클래스의 생성자를 호출하여 부모객체가 먼저 생성되도록
	 해야하는 책임을 가지고 있다. super()는 부모클래스의 생성자를 호출하는 역할을 하게되며
...
public class E01BusinessManMain {
	...
	public static void main(String[] args) {
		...
		man2.tellYourInfo();
		//man2.tellYourName();자식객체로 부모의 메소드 호출 가능
	}
