...
/*
 ...
 오버라이딩 : 함수명, 매개변수, 반환형까지 모두 동일한 함수를 상속관계에 있는 
 	하위클래스에서 재정의 한 것을 말한다. 이 경우 하위클래스에서 정의한 메소드가
 	상위클래스의 메소드를 가리게 되므로 항상 최하위클래스의 메소드가 호출되게 된다.
...
public class E07RideAndLoad01 {
	...
	public static void main(String[] args) {
		...
		/*
		 참조변수에 상관없이 항상 최하위에 오바라이딩 된 메소드가 호출된다.
		...
		/*
		 refId1은 A타입의 참조변수이므로 B타입 혹은 C타입의 참조변수로 참조할 수 없다.
