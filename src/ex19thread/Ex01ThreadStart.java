...
/*
 ...
 Runnable인터페이스를 구현하는 방법을 사용해야한다
 */
class ShowThread extends Thread{
	...
	/*
	 ...
	 Thread 클래스의 run()메소드를 오버라이딩 한것으로 
	 해당 메소드는 직접 호출하면 안되고 start()메소드를 통헤
	 간접적으로 호출하면 단순한 실행만될뿐 쓰레드가 생성되지 않으므로 주의	 
	 */
	@Override
	public void run() {
		for(int i=1;i<=100;i++) {
