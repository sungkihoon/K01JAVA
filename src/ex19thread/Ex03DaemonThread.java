...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		 ...
		 */
		NotThread nt1=new NotThread("첫번째 클레스");
		nt1.notThreadMethod();
		NotThread nt2=new NotThread("두번째 클레스");
		nt2.notThreadMethod();
