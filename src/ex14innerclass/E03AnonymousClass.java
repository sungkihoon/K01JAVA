...
/*
 ...
 - 부모클래스의 메소드를 오버라이딩하는 것이 목적이다.
 - 클래스를 마치 메소드처럼 정의하는 것과 비슷하다.
 - 마지막에 세미클론을 반드시 사용해야 한다.
...
public class E03AnonymousClass {
	...
	public static void main(String[] args) {
		...
		/*
		 다운캐스팅 "(자식클래스명)부모타입의 참조변수"형태로 형변환하여 
		 하위클래스의 멤버에 접근하기 위한 수단이다. 그러나 익명클래스는
		 클래스명이 없기때문에 위와같이 다운캐스팅이 불가능하다.
