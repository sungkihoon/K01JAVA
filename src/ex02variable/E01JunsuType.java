...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		System.out.println("int1 + int 2 = "+ result1);//결과 : 300
		...
		/*
		 ...
		 - byte, short형은 게임캐릭터의 움직임의 표현이나 음원정보등을 저장할 때 사용한다.
		 */
		...
		long long4 = 2200000000l;/*	
			자바컴파일러(CPU)는 정수형 상수를 기본적으로 int형으로 간주하기 떄문에
			위 정수를 메모리에 올리는 순간 에러가 발생한다. 이때는 접미사 (l, L)을 붙여서
			int형 자료가 아닌 long형 자료라는 것을 알려줘야 에러가 발생하지 않는다.
