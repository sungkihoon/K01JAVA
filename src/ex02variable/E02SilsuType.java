...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 소수점이 있는 데이터를 float에 대입하려면 점미사(f or F)사용한다.
