...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		 ...
		 */
		char ch1 = '가';
		//char chStr = '가나다라';[에러발생] 문자열이므로 char변수에 대입불가
		String chStr = "가나다라";
		System.out.println("ch1 = "+ ch1);
		System.out.println("chStr = "+ chStr);
		
		/*
		 아스키코드 : 1byte로 표현할 수 있는 문자(영문, 숫자)를 십진수 코드로 정의한 것을 말함.
		 Ex) A => 65로 표현
		 	 a => 97로 표현
		...
		/*
		 && : 논리And 연산으로 양쪽 모두 참일 떄 참을 반환한다. 나머지는 거짓을 반환한다.
		 || : 논리OR 연산으로 둘중 하나만 참이면 참을 반환한다. 둘다 거짓이면 거짓을 반환한다.
		 */
		boolean bn3 = bn1 && bn2;
		...
		bn3 = '가' > 30000;// 가 => 유니코드 440332이므로 true로 반환
