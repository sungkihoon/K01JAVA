...
/*
 ...
 접근지정자를 붙일 수 있는곳
 	...
 	class명 앞에서는 public과 default만 붙일 수 있다.
 */
public class E01AccessModifierMain {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 ※private으로 선언된 멤버를 외부클래스에서 접근할  떄는 주로 
		...
		new DefaultClass1().myFunc();//객체 생성과 동시에 멤버메소드 호출
		...
		/*
		 다른 패키지에 정의된 default클래스이므로 객체생성이 불가능하다.
