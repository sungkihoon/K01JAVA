...
public class E01If01 {
	...
	public static void main(String[] args)throws IOException {
		...
		/*
		 if(조건식); => 조건식에 상관없이 다음 문장이 실행되는 형태로 세미클론은 문장의 끝을 나타내므로 사용에 주의해야한다.
		 */
		if(num%2 != 0); 
		...
		/*
		 System.in.read()
		 	...
		 	입력한 문자의 아스키코드값을 반환한다. 해당 함수는 IOException을 
		 	기본적으로 가지고있어 이를 무시하기 위해 main()함수에서 throws처리를 해준다.
		 */
		System.out.print("하나의 문자를 입력하세요:");
		int asciiCode = System.in.read();
		...
		/*
		 ...
		 ※ 숫자의 구간을 정할대는 반드시 논리AND를 사용해야 한다.
		 */
		...
		/*
		 아스키코드값을 모를때 구현방법
		char형 문자는 메모리에 저장시 아스키코드값으로 저장되므로
		 아래처럼 비교연산이 가능하다.
		 */
