...
public class E02MethodType01 {
	...
	static void noParamNoRetrun3() {
		int returnValue = 89;
		System.out.println("[Retrun문 이전]");
		
		//return;
		/*
		 이와같이 함수 중간에 return을 쓰게되면 함수가 종료되므로 아래 문장은
		 실행되지 않는 쓰레기코드가 된다. 따라서 return을 사용할 떄는
		 반드시 조건문과 같이 사용해야 한다. 단 함수의 마지막 부분에 있는 경우는 상관없다.
		 */
