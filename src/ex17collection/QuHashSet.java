...
public class QuHashSet {
	...
	public static void main(String[] args) {
		...
		Avengers hero1 = new Avengers(
				"토니스타크", "아이언맨", "Mark-48 수트");
		Avengers hero2 = new Avengers(
				"스티브로져스", "캡틴아메리카", "비브라늄 방패");
		Avengers hero3 = new Avengers(
				"브루스배너", "헐크", "강한피부&점프");
		Avengers hero4 = new Avengers(
				"토니스타크", "아이언맨", "Mark-48 수트");
		...
		if(searchFlag == true) {
			...
			System.out.println("해당 영웅은 없어요ㅠㅠ");
		}
	}
}
