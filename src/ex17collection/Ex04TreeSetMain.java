...
/*
 TreeSet<T> 컬렉션
 - 트리라는 자료구조를기반으로 한 Set컬렉션이다.
 - Set의 기본적인 특성은 동일하나, Tree알고리즘을 통해 정렬되어
 	저장된다. 정렬의 기준은 개발자가 직접 정의할 수 있다.
 - 정렬의 기준을 정하기 위헤 Compareable<T> 인터페이스를 구현해야 한다.
 */
class MyString implements Comparable<MyString>{
	...
	/*
	 정렬의 기준을 위해 오버라이딩 한 메소드로 가나다와 같은 사전순, 문자열의 길이 등
	 다양하게 설정 가능하다. 아래 코드는 오름차순(작은것 -> 큰것)정렬일때 사용한다.
